...
| Wheel | Bundled Java |
| --- | --- |
| `1.0.20260816.1` | `v2026.08.16` |
| `1.0.20260816.2` | same Java tag, second wheel that day |

`pip install altastata==1.0.20260816.1` is valid [PEP 440](https://peps.python.org/pep-0440/).
