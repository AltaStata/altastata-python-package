...
echo "🔧 To run locally (from repo root): ./containers/jupyter/up.sh"
echo "🌐 To run from GHCR (from repo root): docker compose -f containers/jupyter/docker-compose-ghcr.yml up -d"
