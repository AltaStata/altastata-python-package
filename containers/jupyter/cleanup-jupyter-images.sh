...
# Remove ghcr.io/altastata/jupyter-datascience-* (arm64, amd64) and legacy
echo "Removing ghcr.io/altastata/jupyter-datascience* images..."
docker rmi $(docker images --format "{{.Repository}}:{{.Tag}}" | grep "ghcr.io/altastata/jupyter-datascience") 2>/dev/null || echo "  None found"
...
echo "   ./containers/jupyter/build-all-images.sh   # Builds for your platform (arm64 or amd64)"
