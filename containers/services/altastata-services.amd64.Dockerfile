...
# - mycloud/altastata-services/build/libs/altastata-services-2026.09.01-uber.jar
...
COPY mycloud/altastata-services/build/libs/altastata-services-2026.09.01-uber.jar /app/app.jar
