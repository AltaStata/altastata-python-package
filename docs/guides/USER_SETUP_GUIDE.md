...
| Step | Who | What to do |
|------|-----|------------|
| **1. Keys** | You | [Desktop UI](https://github.com/AltaStata/sovereign-data-fabric/blob/main/docs/guides/USER_SETUP_GUIDE.md#desktop-ui-altastata-ui) or [Create keys using CLI](#create-keys-cli--sdk) below. Send the **public key** to your org admin. |
