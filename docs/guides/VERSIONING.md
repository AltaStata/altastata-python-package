...
Same-day rebuilds only bump `.N`; Java stays on `v2026.08.23` (or the prior date tag).

`pip install altastata==1.0.20260823.1` is valid [PEP 440](https://peps.python.org/pep-0440/).
