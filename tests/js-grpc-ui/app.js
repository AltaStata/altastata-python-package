(function () {
  ...
  // Paste local credentials here for manual testing. Never commit real keys.
  const CONFIG = {
    grpcBaseUrl: "http://127.0.0.1:9877",
    userName: "demo_rsa",
    accountPassword: "",
    userProperties: `#My Properties
# Paste your *.user.properties contents here
myuser=demo
...
acccontainer-prefix=altastata-demo-`,
    privateKey: `-----BEGIN RSA PRIVATE KEY-----
Proc-Type: 4,ENCRYPTED
DEK-Info: DES-EDE3,0000000000000000

... paste encrypted PEM body from private.key ...
-----END RSA PRIVATE KEY-----`,
  };
